...
def random_email(firstname, lastname):
    ...
    options = [
        ...
        f"{firstname}{random.choice(['.', '_'])}{lastname}",
        f"{firstname[:3]}{lastname[:3]}",
...
def random_login(firstname, lastname):
    ...
    options = [
        f"{firstname[0]}{lastname}",
        f"{firstname}{lastname[0]}",
        f"{firstname}{random.choice(separators)}{lastname}",
        f"{firstname[:3]}{lastname[:3]}",
        f"{lastname}{firstname[0]}",
    ]
...
def insert_orders(n):
    ...
    for j in range(n):
        ...
        hospital_id = hospital_ids[j % num_hospitals]
        transport_id = transport_ids[j % num_transports] if num_transports > 0 else None
